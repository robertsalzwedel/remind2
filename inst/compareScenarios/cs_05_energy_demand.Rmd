...
showAreaAndBarPlots(data, items_allliq, tot_allliq, orderVars = "user", fill = TRUE)
```
...
#### FE Transport w/ Bunkers Liquids by mode - Bar
```{r FE Transport w/ Bunkers Liquid by mode - Bar}
tot_liq <- "FE|Transport|Liquids"
items_liq <- c(
...
showAreaAndBarPlots(data, items_liq, tot_liq, orderVars = "user", scales = "fixed")
